...
public class Datum implements Parcelable
{
     ...
     * @param createDate
     */
    public Datum(Integer id, Integer categoryId, Category category, String name, String shortName, String description, String ibuMin, String ibuMax, String abvMin, String abvMax, String srmMin, String srmMax, String ogMin, String fgMin, String fgMax, String createDate, String updateDate) {
        super();
        this.id = id;
